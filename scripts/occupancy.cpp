...
int main(int argc, char **argv)
{
    ...
    try
    {
        ...
        // 实例化计时器
        GpuTimer timer_total("Total Pipeline");
        GpuTimer timer_d4("D4 Occupancy");
        ...
        timer_d4.Tock(stream); // D4 结束 (会打印耗时)
        // 总结束
        timer_total.Tock(stream);
        ...
        // =====================================================================
        const char *debug_filename = "../picture/bev_heatmap.ppm";
